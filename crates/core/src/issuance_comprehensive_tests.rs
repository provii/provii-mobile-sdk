...
#[test]
fn test_compute_commitment_randomness_varies() -> std::result::Result<(), Box<dyn std::error::Error>>
{
    let dob = 10000;
...
#[test]
fn test_compute_commitment_c_bytes_always_32() -> std::result::Result<(), Box<dyn std::error::Error>>
{
...
#[test]
fn test_compute_commitment_r_bits_always_128() -> std::result::Result<(), Box<dyn std::error::Error>>
{
    for dob in [0, 1, 100, 10000, i32::MAX] {
        let parts = compute_commitment(dob)?;
        assert_eq!(parts.r_bits.len(), R_BITS_LEN);
...
#[test]
fn test_compute_commitment_very_old_person() -> std::result::Result<(), Box<dyn std::error::Error>>
{
    // 120 years old
...
#[test]
fn test_compute_commitment_structure_fields() -> std::result::Result<(), Box<dyn std::error::Error>>
{
    let parts = compute_commitment(10000)?;
...
#[test]
fn test_compute_commitment_year_boundaries() -> std::result::Result<(), Box<dyn std::error::Error>>
{
...
#[test]
fn test_deterministic_commitment_zero_seed() -> std::result::Result<(), Box<dyn std::error::Error>>
{
    let seed = [0u8; 32];
    let dob = 10000;
...
#[test]
fn test_deterministic_commitment_max_seed() -> std::result::Result<(), Box<dyn std::error::Error>> {
    let seed = [0xFFu8; 32];
    let dob = 10000;
...
#[test]
fn test_deterministic_commitment_edge_dobs() -> std::result::Result<(), Box<dyn std::error::Error>>
{
    let seed = [42u8; 32];
...
#[test]
fn test_finalize_credential_r_bits_too_short() -> std::result::Result<(), Box<dyn std::error::Error>>
{
    let dob = 10000;
    let seed = [42u8; 32];
    let parts = compute_commitment_with_seed(dob, seed)?;
...
#[test]
fn test_finalize_credential_r_bits_too_long() -> std::result::Result<(), Box<dyn std::error::Error>>
{
    let dob = 10000;
    let seed = [42u8; 32];
    let parts = compute_commitment_with_seed(dob, seed)?;
...
#[test]
fn test_finalize_credential_r_bits_all_false() -> std::result::Result<(), Box<dyn std::error::Error>>
{
...
#[test]
fn test_finalize_credential_r_bits_all_true() -> std::result::Result<(), Box<dyn std::error::Error>>
{
...
#[test]
fn test_finalize_credential_max_timestamps() -> std::result::Result<(), Box<dyn std::error::Error>>
{
    let dob = 10000;
    let seed = [42u8; 32];
    let parts = compute_commitment_with_seed(dob, seed)?;
...
#[test]
fn test_assemble_credential_borrowed_header() -> std::result::Result<(), Box<dyn std::error::Error>>
{
    let dob = 10000;
    let seed = [42u8; 32];
    let parts = compute_commitment_with_seed(dob, seed)?;
...
#[test]
fn test_assemble_credential_borrowed_r_bits() -> std::result::Result<(), Box<dyn std::error::Error>>
{
    let dob = 10000;
    let seed = [42u8; 32];
    let parts = compute_commitment_with_seed(dob, seed)?;
...
#[test]
fn test_assemble_credential_slice_conversion() -> std::result::Result<(), Box<dyn std::error::Error>>
{
    let dob = 10000;
    let seed = [42u8; 32];
    let parts = compute_commitment_with_seed(dob, seed)?;
...
#[test]
fn test_assemble_credential_edge_case_dobs() -> std::result::Result<(), Box<dyn std::error::Error>>
{
    let seed = [42u8; 32];
...
#[test]
fn test_unpack_bits_single_byte_to_8_bits() -> std::result::Result<(), Box<dyn std::error::Error>> {
...
#[test]
fn test_unpack_bits_count_exceeds_available() -> std::result::Result<(), Box<dyn std::error::Error>>
{
    let bytes = vec![0xFF];
...
#[test]
fn test_parse_dob_iso_non_leap_year_feb_29() -> std::result::Result<(), Box<dyn std::error::Error>>
{
...
#[test]
fn test_parse_dob_iso_trailing_whitespace() -> std::result::Result<(), Box<dyn std::error::Error>> {
    let result = parse_dob_iso("1990-01-15 ");
    assert!(result.is_err());
    Ok(())
}
...
#[test]
fn test_parse_dob_iso_year_2400_leap_year() -> std::result::Result<(), Box<dyn std::error::Error>> {
...
#[test]
fn test_parse_dob_iso_error_message_quality() -> std::result::Result<(), Box<dyn std::error::Error>>
{
...
#[test]
fn test_days_to_iso_no_trailing_whitespace() -> std::result::Result<(), Box<dyn std::error::Error>>
{
...
#[test]
fn test_days_to_iso_common_ages_roundtrip() -> std::result::Result<(), Box<dyn std::error::Error>> {
...
#[test]
fn test_finalize_rejects_invalid_signature() -> std::result::Result<(), Box<dyn std::error::Error>>
{
...
#[test]
fn test_finalize_rejects_tampered_signature() -> std::result::Result<(), Box<dyn std::error::Error>>
{
